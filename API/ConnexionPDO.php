...
class ConnexionPDO {
    ...
    /**
     * Méthode d'exécution d'une requête de mise à jour (insert, update, delete)
    ...
    /**
     * Méthode d'exécution d'une requête select retournant plusieurs lignes
     * @param string $requete
     * @param array $param
    ...
    /**
     * Méthode d'exécution d'une requête select retournant une ligne
     * @param string $requete
     * @param array $param
     * @return ligne récupérée
     */
