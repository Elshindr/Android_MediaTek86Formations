...
class AccessBDD {
    ...
    /**
     * Propriété qui contient l'instance de connexion à ConnexionPDO
     * @var ConnexionPDO $conn
     */
    public $conn = null;
    ...
    /**
     * Méthode de récupération de toutes les lignes d'une table
    ...
    /**
     * Méthode de récupération d'une ligne d'une table
     * @param string $table nom de la table
    ...
    /**
     * Méthode de suppresion d'une ligne dans une table
     * @param string $table nom de la table
    ...
    /**
     * Méthode d'ajout d'une ligne dans une table
     * @param string $table nom de la table
    ...
    /**
     * Méthode de modification d'une ligne dans une table
     * @param string $table nom de la table
