...
/**
 * Classe contrôleur : reçoit et traite les demandes du point d'entrée
 */
class Controle {

    /**
     * Propriété qui contient l'instance de connexion de AccessBDD
     * @var AccessBDD $accessBDD
     */
    private $accessBDD;
    ...
    public function __construct() {
        try {
            ...
            $this->reponse(500, "*******************erreur serveur pas de co à la bd");
            die();
        }
    }

    /**
     * Méthode qui récupère la réponse renvoyée (affichée) au client au format json
    ...
    /**
     * Méthode qui récupère la requete arrivée en GET (select)
    ...
    public function get($table, $id = null) {
        ...
        if ($result == null || $result == false) {
            $this->reponse(400, "requete get invalide");
        } else {
    ...
    /**
     * Méthode qui récupère la requete arrivée en DELETE
     * @param string $table nom de la table
    ...
    /**
     * Méthode qui récupère la requete arrivée en POST (insert)
     * @param string $table nom de la table
    ...
    /**
     * Méthode qui récupère la requete arrivée en PUT (update)
     * @param string $table nom de la table
     * @param string $id valeur de l'id
     * @param array $champs nom et valeur des champs
     */
